        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!--
                  以前的路由跳转：从A路由跳转到B路由。这里在加入购物车，进行路由跳转之前，先发送请求把购买的产品的信息通过请求的形式通知服务器，服务器进行相应的存储。
                -->
...
export default {
  ...
  methods: {
    ...
    async addShopCar() {
      ...
      //派发一个action，向服务器发请求
      /**调用仓库中的addOrUpdateShopCart，这个方法加上async，返回的一定是Promise，要么成功，要么失败。 */
      try {
        ...
        //下面这种手段可以进行路由跳转传递参数，但会导致传递的字符串乱码
